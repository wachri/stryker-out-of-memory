...
@Component({
  selector: 'app-component1-of-module0',
  templateUrl: './component1-of-module0.component.html',
  styleUrls: ['./component1-of-module0.component.scss']
})
export class Component1OfModule0Component implements OnInit {
