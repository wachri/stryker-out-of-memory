...
@Component({
  selector: 'app-component2-of-module0',
  templateUrl: './component2-of-module0.component.html',
  styleUrls: ['./component2-of-module0.component.scss']
})
export class Component2OfModule0Component implements OnInit {
