...
@Component({
  selector: 'app-component4-of-module0',
  templateUrl: './component4-of-module0.component.html',
  styleUrls: ['./component4-of-module0.component.scss']
})
export class Component4OfModule0Component implements OnInit {
