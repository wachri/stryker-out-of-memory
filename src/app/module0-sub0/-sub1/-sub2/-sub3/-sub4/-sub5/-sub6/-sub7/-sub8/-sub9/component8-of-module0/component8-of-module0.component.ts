...
@Component({
  selector: 'app-component8-of-module0',
  templateUrl: './component8-of-module0.component.html',
  styleUrls: ['./component8-of-module0.component.scss']
})
export class Component8OfModule0Component implements OnInit {
