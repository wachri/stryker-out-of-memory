...
@Component({
  selector: 'app-component9-of-module0',
  templateUrl: './component9-of-module0.component.html',
  styleUrls: ['./component9-of-module0.component.scss']
})
export class Component9OfModule0Component implements OnInit {
