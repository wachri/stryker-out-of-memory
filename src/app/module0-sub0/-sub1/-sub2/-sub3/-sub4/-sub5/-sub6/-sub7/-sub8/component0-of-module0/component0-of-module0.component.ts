...
@Component({
  selector: 'app-component0-of-module0',
  templateUrl: './component0-of-module0.component.html',
  styleUrls: ['./component0-of-module0.component.scss']
})
export class Component0OfModule0Component implements OnInit {
