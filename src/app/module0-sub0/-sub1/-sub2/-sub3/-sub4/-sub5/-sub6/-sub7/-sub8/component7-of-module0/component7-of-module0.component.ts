...
@Component({
  selector: 'app-component7-of-module0',
  templateUrl: './component7-of-module0.component.html',
  styleUrls: ['./component7-of-module0.component.scss']
})
export class Component7OfModule0Component implements OnInit {
