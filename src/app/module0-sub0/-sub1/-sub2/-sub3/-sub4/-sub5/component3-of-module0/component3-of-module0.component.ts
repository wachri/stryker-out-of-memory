...
@Component({
  selector: 'app-component3-of-module0',
  templateUrl: './component3-of-module0.component.html',
  styleUrls: ['./component3-of-module0.component.scss']
})
export class Component3OfModule0Component implements OnInit {
