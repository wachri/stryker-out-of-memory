...
@Component({
  selector: 'app-component5-of-module0',
  templateUrl: './component5-of-module0.component.html',
  styleUrls: ['./component5-of-module0.component.scss']
})
export class Component5OfModule0Component implements OnInit {
