...
@Component({
  selector: 'app-component6-of-module0',
  templateUrl: './component6-of-module0.component.html',
  styleUrls: ['./component6-of-module0.component.scss']
})
export class Component6OfModule0Component implements OnInit {
