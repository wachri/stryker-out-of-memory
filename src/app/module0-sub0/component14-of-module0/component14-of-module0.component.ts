...
@Component({
  selector: 'app-component14-of-module0',
  templateUrl: './component14-of-module0.component.html',
  styleUrls: ['./component14-of-module0.component.scss']
})
export class Component14OfModule0Component implements OnInit {
