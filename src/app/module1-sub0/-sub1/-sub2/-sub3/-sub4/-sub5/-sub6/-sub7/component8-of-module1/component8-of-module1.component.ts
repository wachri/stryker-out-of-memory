...
@Component({
  selector: 'app-component8-of-module1',
  templateUrl: './component8-of-module1.component.html',
  styleUrls: ['./component8-of-module1.component.scss']
})
export class Component8OfModule1Component implements OnInit {
