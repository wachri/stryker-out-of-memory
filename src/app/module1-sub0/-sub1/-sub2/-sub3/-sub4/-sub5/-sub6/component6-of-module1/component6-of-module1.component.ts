...
@Component({
  selector: 'app-component6-of-module1',
  templateUrl: './component6-of-module1.component.html',
  styleUrls: ['./component6-of-module1.component.scss']
})
export class Component6OfModule1Component implements OnInit {
