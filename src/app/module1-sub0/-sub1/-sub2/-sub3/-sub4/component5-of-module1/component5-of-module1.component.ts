...
@Component({
  selector: 'app-component5-of-module1',
  templateUrl: './component5-of-module1.component.html',
  styleUrls: ['./component5-of-module1.component.scss']
})
export class Component5OfModule1Component implements OnInit {
