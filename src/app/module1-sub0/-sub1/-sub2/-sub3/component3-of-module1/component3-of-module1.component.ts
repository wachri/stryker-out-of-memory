...
@Component({
  selector: 'app-component3-of-module1',
  templateUrl: './component3-of-module1.component.html',
  styleUrls: ['./component3-of-module1.component.scss']
})
export class Component3OfModule1Component implements OnInit {
