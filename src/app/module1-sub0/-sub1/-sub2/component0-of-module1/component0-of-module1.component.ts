...
@Component({
  selector: 'app-component0-of-module1',
  templateUrl: './component0-of-module1.component.html',
  styleUrls: ['./component0-of-module1.component.scss']
})
export class Component0OfModule1Component implements OnInit {
