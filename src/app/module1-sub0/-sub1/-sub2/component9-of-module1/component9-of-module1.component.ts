...
@Component({
  selector: 'app-component9-of-module1',
  templateUrl: './component9-of-module1.component.html',
  styleUrls: ['./component9-of-module1.component.scss']
})
export class Component9OfModule1Component implements OnInit {
