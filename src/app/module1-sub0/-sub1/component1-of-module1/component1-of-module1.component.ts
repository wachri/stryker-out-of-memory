...
@Component({
  selector: 'app-component1-of-module1',
  templateUrl: './component1-of-module1.component.html',
  styleUrls: ['./component1-of-module1.component.scss']
})
export class Component1OfModule1Component implements OnInit {
