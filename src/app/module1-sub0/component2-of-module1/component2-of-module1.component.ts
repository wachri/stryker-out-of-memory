...
@Component({
  selector: 'app-component2-of-module1',
  templateUrl: './component2-of-module1.component.html',
  styleUrls: ['./component2-of-module1.component.scss']
})
export class Component2OfModule1Component implements OnInit {
