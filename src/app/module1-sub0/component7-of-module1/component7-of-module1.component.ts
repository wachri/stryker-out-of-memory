...
@Component({
  selector: 'app-component7-of-module1',
  templateUrl: './component7-of-module1.component.html',
  styleUrls: ['./component7-of-module1.component.scss']
})
export class Component7OfModule1Component implements OnInit {
